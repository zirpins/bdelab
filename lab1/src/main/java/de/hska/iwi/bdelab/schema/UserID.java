...
public class UserID extends org.apache.thrift.TUnion<UserID, UserID._Fields> {
  ...
  public static UserID user_id(String value) {
    UserID x = new UserID();
    x.set_user_id(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      case USER_ID:
        ...
        throw new ClassCastException("Was expecting value of type String for field 'user_id', but got " + value.getClass().getSimpleName());
      default:
