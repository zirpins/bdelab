...
public class UserID extends org.apache.thrift.TUnion<UserID, UserID._Fields> {
  ...
  public static UserID ip(String value) {
    UserID x = new UserID();
    x.set_ip(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case IP:
        ...
        throw new ClassCastException("Was expecting value of type String for field 'ip', but got " + value.getClass().getSimpleName());
      default:
  ...
  protected Object standardSchemeReadValue(org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TField field) throws org.apache.thrift.TException {
    ...
    if (setField != null) {
      switch (setField) {
        ...
        case IP:
          if (field.type == IP_FIELD_DESC.type) {
            String ip;
            ip = iprot.readString();
            return ip;
          } else {
  ...
  public String get_ip() {
    if (getSetField() == _Fields.IP) {
      return (String)getFieldValue();
    } else {
      throw new RuntimeException("Cannot get field 'ip' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void set_ip(String value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.IP;
    value_ = value;
  }
  ...
  public boolean is_set_ip() {
    return setField_ == _Fields.IP;
  }
