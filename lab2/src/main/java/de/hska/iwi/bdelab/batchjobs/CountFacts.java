...
public class CountFacts {
	...
	public static void main(String[] args) throws Exception {
		...
		String masterpath = FileUtils.getTmpPath(fs, FileUtils.MASTER_PAIL, false);
		// 
		...
		FileOutputFormat.setOutputPath(conf, new Path(FileUtils.getTmpPath(fs, FileUtils.RESULTS, true)));
		////////////////////////////////////////////////////////////////////////////
