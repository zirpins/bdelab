...
public class UserProperty implements org.apache.thrift.TBase<UserProperty, UserProperty._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(UserProperty other) {
    ...
    UserProperty typedOther = (UserProperty)other;
